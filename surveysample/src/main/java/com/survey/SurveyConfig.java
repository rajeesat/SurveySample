...
public class SurveyConfig extends HttpServlet {
    ...
    protected String performGeoCoding(String location){
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            PreparedStatement pst =(PreparedStatement) conn.prepareStatement("insert into surveysample.surveydetail(familyname,firstname,middlename,gender,dateofbirth,income,complete_address,coordinates,mobilenumber,emailaddress,presentiprovider,comments,remarks,start_time,end_time) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");//try2 is the name of the table
            ...
            pst.setString(14,startTime);
            pst.setString(15,endTime);
