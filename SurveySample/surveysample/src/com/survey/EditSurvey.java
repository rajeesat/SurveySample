...
public class EditSurvey extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int newSurveyId = Integer.parseInt(surveyId);
        System.out.println("check 2"+surveyId);
        ...
        try{
            ...
            PreparedStatement pst =(PreparedStatement) conn.prepareStatement("update surveysample.surveydetail set familyname = ?,firstname =?,middlename = ?,gender = ?,dateofbirth = ?,income = ?,complete_address = ?,coordinates = ?,mobilenumber = ?,emailaddress = ?,presentiprovider = ?,comments = ?,remarks = ? where surveyid = ?");//try2 is the name of the table
